...
Las fichas de los personajes tienen sentido dentro de un contexto racial y de razas de características similares. Es decir, un Tauren con 5 de Físico no será más débil que un Gnomo con 8 de Físico, si no que en relación entre sus pueblos, el Tauren representará a una criatura relativamente débil y más propensa a las enfermedades, mientras que el gnomo será un ejemplar destacable de su raza. Como siempre, a nivel de rol la coherencia prima sobre todo.
...
(D) Armas cuerpo a cuerpo sutil
Al adquirir la habilidad hay que especificar el arma relacionada, ejemplo: "Espada Ligera". Esta habilidad representa el conocimiento y la experiencia de uso con armas cuerpo a cuerpo, o incluso sin armas usando técnicas de arte marcial. A mayor nivel, mayor probabilidad de acertar y golpear. Esto incluiría puñetazos, espadas ligeras, dagas, bastones, etcétera. Su dificultad se basa en la defensa del objetivo y las variables como atacar por la espalda.
(D) Equitación
...
(D) Lanzador
Permite arrojar elementos genéricos (no armas) en el blanco deseado de una manera más precisa: Granadas, Piedras, etc... Distancia máxima 2 turnos.
(D) Nadar
Se utiliza para definir el nivel de natación. Con 1 punto se sabe nadar, sólo habría que tirar para realizar acciones difíciles como ganar una carrera o cruzar el estrecho a nado o en situaciones complejas como un naufragio, aguas turbulentas, etc...
(D) Robar bolsillos
...
Aptitud para manipular y forzar mecanismos de seguridad, desde la clásica cerradura hasta candados y otros cerramientos. También sirve para localizar y desactivar trampas y otros artefactos preparados para dispararse contra los intrusos, así como para ponerlos y saber como ocultarlos. Para detectar trampas esta habilidad se sumará a nuestro atributo de Percepción en vez de Destreza.
(D) Bailar
...
Honor Enano
Justicia Kaldorei
Sistema Gnómico de Justicia
Códigos Draenei
Honor Orco
Ley Trol
Honor Tauren
Entramado Goblin
Justicia Thalassiana
Ley de Lordaeron
Justicia Pandaren
(I) Navegar
...
(I) Cirugía/Anatomía:
Conocimiento vinculado a la anatomía de razas comunes, vinculadas al trasfondo y conocimiento del personaje, y a procesos curativos y médicos  más avanzados. Para operar a alguien se habrá de realizar una tirada vs Dificultad 14 con los diferentes modificadores, todos son acumulables. Un personaje solo puede hacer una tirada para operar por objetivo por escena:
Tiempo adecuado: -2 Dificultad
Ambiente calmo: -2 Dificultad
Materiales apropiados: -2 Dificultad
Operación simple: -2 Dificultad
Tiempo insuficiente: +2 Dificultad
Ambiente estresante/peligroso: +2 Dificultad
Falta de materiales: +2 Dificultad
Operación compleja:  +2 Dificultad
(I)Arquitectura: 
...
(P) Armas a distancia
Al adquirir la habilidad hay que especificar el arma relacionada, ejemplo: "Arco Largo" .Representa el conocimiento y la experiencia de uso con armas a distancia. A mayor nivel, mayor probabilidad de acertar y golpear blancos lejanos (enemigos, objetos). Esto incluiría armas de fuego, arcos, ballestas, etcétera. Su dificultad se basa en la distancia del objetivo y la cobertura que tiene así como otros modificadores.
(P) Advertir/Notar
...
Puntos de Vida (PdV)	Físico x 4
Puntos de Maná (PdM)	Inteligencia x 4 ó Espiritu x 4
Iniciativa 	Percepción + Reflejos
Ataque	Habilidad de Arma + Físico ó Destreza ó Percepción
...
10 Ataque a Distancia (Arco Largo)
8 Defensa
...
Inteligencia
1 Comercio
1 Leyes (Justicia Sin'dorei)
1 Conocimiento/Historia (El Alto Reino Elfico)
2 Detectar Energia Arcana
1 Encantar Arma (Piromancia)
2 Evocación Básica (Piromancia)
Percepción
 2 Arco Largo
2 Advertir/Notar
1 Música
...
El nivel de las habilidades se encuentra segmentado en diversos rangos que representan nuestra maestría con dicha destreza (Aprendiz, Formado, Diestro, Experto, Maestro).  Para subir de nivel la habilidad que pretendemos mejorar rellenaremos el formulario "Solicitar habilidad" del menú superior de la web teniendo en cuenta los siguientes dos aspectos:

Personaje con historia completa (Las historias rápidas tienen el nivel limitado a máximo 2)
Volver a subir de nivel la misma habilidad tomará un tiempo de espera igual a tantas semanas como el nivel más alto del último grupo de habilidades subidas, ejemplo: Solicitar Arco Corto nivel 4, Nadar nivel 3, Advertir/Notar Nivel 3 y Defensa Nivel 2 dará un tiempo de espera de 4 semanas antes de volver a pedir habilidades.
Se pueden aprender o mejorar habilidades hasta un máximo de 4 a la vez dentro de un periodo de tiempo igual a tantas semanas como el nivel más alto de las habilidades solicitadas. En caso de retrasos en la revisión de habilidades, una vez haya pasado el tiempo apropiado, un personaje podrá volver a solicitar habilidades, pero estas tendrán que ser distintas de las que aun esperan corrección. Aun así, ante dos retrasos seguidos, contacten con los narradores o maestres, pues a veces es posible que se haya pasado.
Si el nivel de habilidad solicitado no inicia ningún rango nuevo (2, 4, 6, 8, 10) se enviará el formulario sin necesidad de rellenar el último apartado del formulario "Información para desbloquear rango". Esto significa que el único requisito para subir a esos niveles es el tiempo

Si el nivel solicitado inicia un rango nuevo (1, 3, 5, 7, 9) será necesario rellenar el último apartado del formulario " Información para desbloquear rango" adjuntando la información que acredite la adquisición de dicho conocimiento. Abajo se define los requisitos según el rango solicitado

A nivel de rol, por norma general, un personaje podrá servir de guia y maestro a otro personaje en una habilidad o disciplina hasta dos rangos por debajo de su rango de conocimiento. Ej: Un personaje de rango Diestro podrá instruir hasta el rango de Aprendiz a otro personaje. Un personaje de rango Experto, podrá instruir hasta el rango de Formado, etc...
...
Obtener una habilidad en este nivel se traduce básicamente en haber adquirido un conocimiento nuevo, el cual aún está dando sus primeros pasos de bebé en lo que representa esa disciplina en toda su totalidad. Los requisitos para poder obtener este nivel son los siguientes.

Para aprender una nueva habilidad a nivel 1 habremos de realizar 1 rol de naturaleza temática donde nuestro personaje pueda, de manera coherente, adquirir este conocimiento. Estos roles se estructuran de la siguiente manera:
Un personaje dirigirá estos roles, y este usuario decidirá la habilidad que será entrenada y adquirida en el mismo. A mayores, cualquier personaje participante, incluido aquel que dirige este rol, podrá usarlo para justificar la adquisición de otra habilidad, hechizo, aptitud, etc... 
Estos roles no tienen porqué ser entrenamientos (Sin embargo los roles de temática de entrenamiento servirán igualmente), y la habilidad entrenada en cuestión no tiene porqué ser usada directamente por los personajes en estos roles, si no que sea coherente en su desarrollo:
Ejemplo:
Laurenthius es un Paladín de la Mano de Plata que desea instruir a sus compañeros en Religión (Luz Sagrada), para ello, realiza un rol casual donde varios jugadores acuden a una pequeña capilla, hablando con su viejo sacerdote, y acuden a recuperar varios tomos sagrados. Realizan la empresa, y el rol de aprendizaje concluye con una pequeña charla del sacerdote. Todos los participantes podrán solicitar la habilidad de Religión (Luz Sagrada) a nivel 1. A mayores, cada uno podrá justificar con este rol otra habilidad coherente:
Laurenthius el Paladín también usa este rol para justificar aprender Golpe de Cruzado (Dificultad 16) a nivel 1, pues los libros sacros traían información sobre estas técnicas sagradas.
Sara la Guerrera, habiendo luchado con los bandidos para recuperar estos tomos sagrados, usa el rol para justificar aprender Golpe de Escudo pues es una aptitud de rango Aprendiz.
Pepo el enano, habiéndose interesado por otros libros que encontraron, usa este rol para justificar aprender Tradición/Historia (Reinos Humanos) a nivel 1.
Tobias el Brujo, que finge ser un mercenario , ha encontrado en los escritos de los bandidos un texto oscuro, pues estos trabajaban para una secta que buscaba esos libros sagrados (Habiendo sido esto masteado por Laurenthius, y haberlo consultado mutuamente). Como es coherente, usa este rol para justificar adquirir un hechizo de Dificultad 14.
Hechizos: A diferencia de recetas o aptitudes, todo hechizo se aprende a Nivel 1 y se desarrolla lentamente hasta alcanzar una maestría que nos permita ejecutarlo con habilidad en combate. Por esto, la cantidad de estos roles necesarios para aprender un hechizo a Nivel 1 aumenta según la dificultad del hechizo siguiendo la siguiente tabla:
Dificultad 12-16: 1 rol
Dificultad 18: 2 roles
Dificultad 20: 3 roles
Dificultad 22: 4 roles
 

Nivel de Habilidad 3: Formado

Una vez en este nivel de habilidad, nuestro personaje ha dejado atrás el conocimiento de un aprendiz en la materia en cuestión y se puede decir que domina los conceptos básicos de la disciplina. Los requisitos para poder obtener este nivel son los siguientes.

Aprender una aptitud | Receta de rango Formado: Realizar un rol casual con otras personas, en las cuales roleen la búsqueda y/o adquisición de este conocimiento por nuestro personaje. Estos roles siguen las reglas explicadas en Rango Aprendiz.
Mejorar una habilidad ya aprendida: Haber usado al menos la habilidad en 3 roles masteados nuestros o de otras personas, ya sean roles casuales, eventos, combate, resolver problemas, etc...
...
Aprender una aptitud | Receta de rango Diestro: Realizar un rol casual con otras personas, en las cuales roleen la búsqueda y/o adquisición de este conocimiento por nuestro personaje. Estos roles siguen las reglas explicadas en Rango Aprendiz.
Masteos: Se requiere mínimo 2 sesiones de masteo (Las sesiones de masteo pueden ser de temática libre o de temática enfocada en la habilidad). Una gran fiesta donde las habilidades de baile de los personajes tengan relevancia para resolver la trama o el conflicto del rol en cuestión, la busqueda de algun tipo de libro o tomo dificil para resolver ese bache en nuestra investigación académica o mágica, o simplemente eventos y tramas a gusto personal, etc... Un evento con muchas sesiones de masteo puede usarse para varias habilidades, e incluso cumplimentar una habilidad con sesiones de distintos masteos. Una sesión de masteo solo se puede usar una vez por cada habilidad.
Ejemplo: Un evento que ha durado 5 días, contaría como 5 sesiones de masteo para usar a la hora de "pagar" distintas habilidades. Una tarde de masteo improvisado también pasaría a formar parte de la "cartera" de masteos de un personaje.
Mejorar una habilidad ya aprendida: Haber usado al menos la habilidad en 3 roles masteados nuestros o de otras personas, ya sean roles casuales, eventos, combate, resolver problemas, etc...
Masteos: Se requiere mínimo 2 sesiones de masteo (Las sesiones de masteo pueden ser de temática libre o de temática enfocada en la habilidad). Una gran fiesta donde las habilidades de baile de los personajes tengan relevancia para resolver la trama o el conflicto del rol en cuestión, la busqueda de algun tipo de libro o tomo dificil para resolver ese bache en nuestra investigación académica o mágica, o simplemente eventos y tramas a gusto personal, etc... Un evento con muchas sesiones de masteo puede usarse para varias habilidades, e incluso cumplimentar una habilidad con sesiones de distintos masteos. Una sesión de masteo solo se puede usar una vez por cada habilidad.
Ejemplo: Un evento que ha durado 5 días, contaría como 5 sesiones de masteo para usar a la hora de "pagar" distintas habilidades. Una tarde de masteo improvisado también pasaría a formar parte de la "cartera" de masteos de un personaje.
...
Aprender una aptitud | Receta de rango Experto: Realizar 2 roles casuales con otras personas, en las cuales roleen la búsqueda y/o adquisición de este conocimiento por nuestro personaje. Estos roles siguen las reglas explicadas en Rango Aprendiz.
Masteos: Se requiere mínimo 4 sesiones de masteo (Las sesiones de masteo pueden ser de temática libre o de temática enfocada en la habilidad). Una gran fiesta donde las habilidades de baile de los personajes tengan relevancia para resolver la trama o el conflicto del rol en cuestión, la busqueda de algun tipo de libro o tomo dificil para resolver ese bache en nuestra investigación académica o mágica, o simplemente eventos y tramas a gusto personal, etc... Un evento con muchas sesiones de masteo puede usarse para varias habilidades, e incluso cumplimentar una habilidad con sesiones de distintos masteos. Una sesión de masteo solo se puede usar una vez por cada habilidad.
Ejemplo: Un evento que ha durado 5 días, contaría como 5 sesiones de masteo para usar a la hora de "pagar" distintas habilidades. Una tarde de masteo improvisado también pasaría a formar parte de la "cartera" de masteos de un personaje.
Mejorar una habilidad ya aprendida: Haber usado al menos la habilidad en 7 roles masteados nuestros o de otras personas, ya sean roles casuales, eventos, combate, resolver problemas, etc...
Masteos: Se requiere mínimo 4 sesiones de masteo (Las sesiones de masteo pueden ser de temática libre o de temática enfocada en la habilidad). Una gran fiesta donde las habilidades de baile de los personajes tengan relevancia para resolver la trama o el conflicto del rol en cuestión, la busqueda de algun tipo de libro o tomo dificil para resolver ese bache en nuestra investigación académica o mágica, o simplemente eventos y tramas a gusto personal, etc... Un evento con muchas sesiones de masteo puede usarse para varias habilidades, e incluso cumplimentar una habilidad con sesiones de distintos masteos. Una sesión de masteo solo se puede usar una vez por cada habilidad.
Ejemplo: Un evento que ha durado 5 días, contaría como 5 sesiones de masteo para usar a la hora de "pagar" distintas habilidades. Una tarde de masteo improvisado también pasaría a formar parte de la "cartera" de masteos de un personaje.
...
Aprender una aptitud | Receta de rango Maestro: Realizar 3 roles casuales con otras personas, en las cuales roleen la búsqueda y/o adquisición de este conocimiento por nuestro personaje. Estos roles siguen las reglas explicadas en Rango Aprendiz.
Masteos: Se requiere mínimo 6 sesiones de masteo (Las sesiones de masteo pueden ser de temática libre o de temática enfocada en la habilidad). Una gran fiesta donde las habilidades de baile de los personajes tengan relevancia para resolver la trama o el conflicto del rol en cuestión, la busqueda de algun tipo de libro o tomo dificil para resolver ese bache en nuestra investigación académica o mágica, o simplemente eventos y tramas a gusto personal, etc... Un evento con muchas sesiones de masteo puede usarse para varias habilidades, e incluso cumplimentar una habilidad con sesiones de distintos masteos. Una sesión de masteo solo se puede usar una vez por cada habilidad.
Ejemplo: Un evento que ha durado 5 días, contaría como 5 sesiones de masteo para usar a la hora de "pagar" distintas habilidades. Una tarde de masteo improvisado también pasaría a formar parte de la "cartera" de masteos de un personaje.
Mejorar una habilidad ya aprendida: Haber usado al menos la habilidad en 10 roles masteados nuestros o de otras personas, ya sean roles casuales, eventos, combate, resolver problemas, etc...
Masteos: Se requiere mínimo 6 sesiones de masteo (Las sesiones de masteo pueden ser de temática libre o de temática enfocada en la habilidad). Una gran fiesta donde las habilidades de baile de los personajes tengan relevancia para resolver la trama o el conflicto del rol en cuestión, la busqueda de algun tipo de libro o tomo dificil para resolver ese bache en nuestra investigación académica o mágica, o simplemente eventos y tramas a gusto personal, etc... Un evento con muchas sesiones de masteo puede usarse para varias habilidades, e incluso cumplimentar una habilidad con sesiones de distintos masteos. Una sesión de masteo solo se puede usar una vez por cada habilidad.
Ejemplo: Un evento que ha durado 5 días, contaría como 5 sesiones de masteo para usar a la hora de "pagar" distintas habilidades. Una tarde de masteo improvisado también pasaría a formar parte de la "cartera" de masteos de un personaje.
...
En Azeroth existen multitud de razas cada una con su propia historia, cultura y rol. Cuando creemos nuestro personaje, probablemente la raza sea lo primero que pensemos, siendo su rol lo segundo, y el planificar la ficha lo tercero. En el servidor ofrecemos un variopinto elenco de razas, normalmente agrupadas y seleccionadas siguiendo lógicas de coherencia de rol y cohabitabilidad unas con otras, con el objetivo de enriquecer y dar variedad de rol a los diversos núcleos raciales para que no haya necesidad de moverse a otros en busca de diversidad cultural.

Las razas jugables y roleables en la comunidad son las siguientes, y cada una, tiene acceso a las siguientes disciplinas mágicas o energias, en base a su accesibilidad por trasfondo, cultura, etc...

Cada raza tendrá unas raciales asociadas. Aunque muchas veces es perfectamente razonable ignorarlas, si no deseamos complicar demasiado nuestro rol, como estándar se aplicarán en el servidor a la hora de jugar las diversas razas. Cuando una racial modifique ciertos valores o atributos, estos habrán de retocarse manualmente en la ficha antes de enviarla para ser revisada: ->Sistema de Raciales<-

Aunque las razas, por comodidad de explicación, se agrupen en distintos grupos, ideas como "Horda" o "Alianza" como mega alianzas de especies no existen en nuestro servidor, estando las distintas razas separadas unas de otras, con gobiernos independientes, pero unidas o enfrentadas por numerosos tratados de alianzas, comercio, amistad, e historia.

Razas jugables:
Reinos Aliados:
Humanos: Los humanos son la raza más extendida de Azeroth, y una de las más versátiles. Sean de uno de los siete reinos, o de algún grupo humano más peculiar, lo pueden todo. O casi todo.
Magia accesible: Luz, Magia Arcana, Vacío, Magia Vil, Druidismo: Brujas de la cosecha de gilneas, solo equilibrio | restauración hasta Dif 14, Chamanismo: Sabiomar de Kul'tiras (Agua y Aire).
Enanos: Los enanos, sean de la variante que sean, son una visión común en los reinos del este, de sur a norte y de norte a sur. De estatura menuda y ancha constitución, son aliados ancestrales de los humanos. O lo son, la mayoría.
Magia accesible: Luz (Barbabronce), Magia Arcana (Barbabronce, No Nigromancia, Hierronegro), Vacío (Barbabronce, Hierronegro), Magia Vil (Barbabronce, Hierro Negro), Chamanismo (Martillo Salvaje, Hierro Negro modificando hechizos por fuego o tierra o Chamanismo Oscuro)
Cuando creamos nuestro personaje, normalmente pensaremos en su apariencia física, tal vez por una foto o dibujo que nos inspira, o tras probar combinaciones hasta encontrar una que nos guste con la personalización ofrecida por el videojuego World of Warcraft. 

Normalmente, hay libertad total en la personalización de nuestro personaje dentro de los parámetros que nos ofrece el videojuego, pero si hay alguna duda, por algo que nos parezca extravagante o extraño, siempre recomendamos preguntar antes.

A continuación se establecerán un par de tablas donde se distribuyen las alturas y pesos promedios de las diversas razas, separadas por sexos. Normalmente esto solo son guías, y hay margen de romper los limites minimos o máximos por unos margen de 1-5 cm de altura sin que haya problema alguno, siendo mucho más flexibles los pesos basados en la constitución de nuestro personaje. Personajes excepcionales en estos respectos, sin embargo, como un humano que mida 2,20m, o un orco especialmente raquitico de 1,60m, es mejor consultarlos previamente antes de enviar la historia del mismo.

Tamaños de las razas:
Pequeño: Hozen, Gnomo, Goblin, Vulpera
Medio: Humanos, Enanos, Quel'dorei, Sin'dorei, Kaldorei, Driades, Draenei, Tábidos, Huargen, Orcos, Trols de la Selva, Pandaren, Jinyu, Trols Zandalari, Sethrak, Trols del Bosque, Trols de la Arena 
Grande: Tauren, Furbolg, Ogro, Mok'nathal
 

 Físico de las razas 
Raza	Peso Promedio	Altura Promedio
Humanos	70-95 Kg (H)
50-70 Kg (M)	1,70m-1,85m(H)
1,60m-1,75(M)
Enanos	80-110 Kg (H)
65-90 Kg (M)	1,35m-1,50m(H)
1,30m-1,45(M)
Quel'dorei
Sin'dorei	60-80 Kg (H)
40-65 Kg (M)	1,75m-1,90m(H)
1,65m-1,80m(M)
Kaldorei	130-180 Kg (H)
85-130 Kg (M)	2,05m-2,30m (H)
1,95m-2,20m(M)
Furbolg	200-350 Kg (H)
180-280 Kg(M)	2,00m-2,40m (H)
2,00m-2,30m(M)
Driades	60-80 Kg	1,80m-2,10m
Draenei	
140-200 Kg (H)
95-140 Kg(M)
...
2,05m-2,25m(M)
Tábidos	100-160Kg(H)
80-135Kg(M)	1,95m-2,10m(H)
1,80m-2,05(M)
Gnomos	35-50Kg(H)
30-45Kg(M)	95cm-1,10m(H)
90cm-1,05m(M)
Huargen	110-140Kg(H)
100-130Kg(M)	1,95m-2,10m(H)
1,90m-2,05m(M)
Orcos	100-160Kg(H)
95-125Kg(M)	1,95m-2,15m(H)
1,85-2,05m(M)
Trols Selva | Arena	95-160Kg(H)
90-125Kg(M)	2,15m-2,45m(H)
2,05m-2,25m(M)
Tauren	250-350Kg(H)
180-280Kg(M)	2,35m-2,70m(H)
2,30m-2,50m(M)
Ogros	450-800Kg(H)
430-600Kg(M)	2,90m-3,60m(H)
2,60m-3,20m(M)
Mok'nathal	240-400Kg(H)
200-300Kg(M)	2,40m-2,75m(H)
2,30m-2,55m(M)
Goblins	45-70Kg(H)
30-50Kg(M)	1,00m-1,20m(H)
95cm-1,15m(M)
Pandaren	140-200Kg(H)
110-150Kg(M)	2,00m-2,20m(H)
1,90-2,10m(M)
Hozen	45-80 Kg (H)
30-65 Kg (M)	1,35m-1,50m(H)
1,30m-1,45(M)
Jinyu	85-110 Kg (H/M)	2,05m-2,30m (H/M)
Trols Zandalari | Bosque	105-175Kg(H)
